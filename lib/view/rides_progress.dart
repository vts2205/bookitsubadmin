...
class _RidesInProgressPageState extends State<RidesInProgressPage> {
  ProgressRidesListModel progressRidesListModel;
  ...
  getData() async {
    progressRidesListModel = await APIService().progressRidesList();
    if (progressRidesListModel != null) {
      setState(() {
        isLoading = true;
      });
    }
    ...
    return Container(
        ...
        child: isLoading == false
            ...
            : DataTable2(
                ...
                rows: progressRidesListModel.userValue
                    .map((e) => DataRow(cells: [
                          DataCell(CustomText(
                            text: (e.id.toString()),
                            size: 12,
